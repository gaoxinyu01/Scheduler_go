...
// 自由任务驳回
func (l *TaskFreeRejectToUpstreamNodeLogic) TaskFreeRejectToUpstreamNode(in *workflowclient.TaskFreeRejectToUpstreamNodeReq) (*workflowclient.CommonResp, error) {
	...
	//reject to 节点
	RejectToNode, err := l.GetInstanceNode(taskInfo.ProcId, in.RejectToNodeId)
	if err != nil {
		return nil, err
	}
	//判断节点是否已处理
...
func (l *TaskFreeRejectToUpstreamNodeLogic) GetInstanceNode(ProcessInstanceID int64, NodeID string) (modelx.Node, error) {
	//获取task所在的node
...
// 从缓存中获取流程节点定义
func (l *TaskFreeRejectToUpstreamNodeLogic) GetProcCache(ProcessID int64) (ProcNodes, error) {
...
// 获取流程定义 by 流程ID
func (l *TaskFreeRejectToUpstreamNodeLogic) GetProcessDefine(ProcessID int64) (modelx.Process, error) {
	type result struct {
		Resource string
	}
	var r result
...
func (l *TaskFreeRejectToUpstreamNodeLogic) taskRevoke(TaskID int64) error {
...
func (l *TaskFreeRejectToUpstreamNodeLogic) ProcessNode(ProcessInstanceID int64, CurrentNode *modelx.Node, PrevNode modelx.Node) error {
	//这里处理开始事件
...
func RunNodeEvents(EventNames []string, ID int64, CurrentNode *modelx.Node, PrevNode modelx.Node) error {
...
func (l *TaskFreeRejectToUpstreamNodeLogic) TaskNodeHandle(ProcessInstanceID int64, CurrentNode *modelx.Node, PrevNode modelx.Node) ([]int64, error) {
	//获取节点用户
...
// GateWay节点处理
func (l *TaskFreeRejectToUpstreamNodeLogic) GateWayNodeHandle(ProcessInstanceID int64, CurrentNode *modelx.Node, PrevTaskNode modelx.Node) error {
...
func (l *TaskFreeRejectToUpstreamNodeLogic) InstanceNodeIsFinish(ProcessInstanceID int64, NodeID string) (int64, error) {
...
func (l *TaskFreeRejectToUpstreamNodeLogic) EndNodeHandle(ProcessInstanceID int64, Status int64) error {
...
// 1、获得用户变量
// 2、用户去重
func (l *TaskFreeRejectToUpstreamNodeLogic) resolveNodeUser(ProcessInstanceID int64, node modelx.Node) ([]string, error) {
	//匹配节点用户变量
...
func (l *TaskFreeRejectToUpstreamNodeLogic) ResolveVariables(ProcessInstanceID int64, Variables []string) (map[string]string, error) {
...
func (l *TaskFreeRejectToUpstreamNodeLogic) SetVariable(ProcessInstanceID int64, variable string) (string, bool, error) {
