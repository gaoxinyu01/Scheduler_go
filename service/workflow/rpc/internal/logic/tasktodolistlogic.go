...
// 获取待办任务
func (l *TaskToDoListLogic) TaskToDoList(in *workflowclient.TaskToDoListReq) (*workflowclient.TaskToDoListResp, error) {
	...
	return &workflowclient.TaskToDoListResp{
		Total: count,
		List:  list,
	}, nil
